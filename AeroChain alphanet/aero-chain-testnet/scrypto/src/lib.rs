...
blueprint! {
    ...
    impl DoNotFly {
        pub fn instantiate_list(price: Decimal) -> (ComponentAddress) {
            ...
            let mut component = Self {
                ...
                admin: admin_badge.resource_address(),
                admin_badge_bucket: Vault::with_bucket(admin_badge),
